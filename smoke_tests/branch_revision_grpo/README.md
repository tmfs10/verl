...
The smoke allows up to 2,560 critique tokens inside a 5,120-token context. The product prompt explicitly bounds the critique to three short findings and reserves its final content for the required tags; the larger hard cap is a fail-safe for Qwen3 reasoning rather than permission to omit the structured edit.
